...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/05/17 19:36:26 by arabelo-          #+#    #+#             */
/*   Updated: 2024/05/24 13:47:58 by arabelo-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
DiamondTrap::DiamondTrap(const DiamondTrap &diamond): ClapTrap(diamond._name + "_clap_name")  {
	_name = diamond._name;
	...
	ClapTrap::energyPoints = diamond.hitPoints;
